  ...
  <x-card class="p-10 max-w-lg mx-auto mt-24">
    ...
    <form method="POST" action="/listings" enctype="multipart/form-data">
      ...
      <div class="mb-6">
        ...
        @error('company')
        <p class="text-violet-500 text-xs mt-1">{{$message}}</p>
        @enderror
      </div>
      ...
      <div class="mb-6">
        ...
        <input type="text" class="border border-gray-200 rounded p-2 w-full" name="title"
          placeholder="Example: Senior Developer" value="{{old('title')}}" />
      ...
      <div class="mb-6">
        <button class="bg-violet-500 text-white rounded py-2 px-4 hover:bg-black">
          Create Gig
        </button>
